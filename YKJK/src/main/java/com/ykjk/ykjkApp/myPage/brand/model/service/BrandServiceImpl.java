...
public class BrandServiceImpl implements BrandService {
	...
	public List<Map<String, String>> selectBrandOrderList(int cPage, int numPerPage, String brand_name) {
		System.out.println("order :: 서비스 왔어요");
